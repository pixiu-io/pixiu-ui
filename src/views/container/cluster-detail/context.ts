...
export const clusterDetailRefreshKey: InjectionKey<() => Promise<void>> =
  Symbol('clusterDetailRefresh')

/** 集群详情左侧菜单当前激活项（如 config、pods、workloads） */
export const clusterDetailActiveMenuKey: InjectionKey<ComputedRef<string>> = Symbol(
