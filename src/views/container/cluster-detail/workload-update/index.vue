      ...
      <div class="deploy-create-main">
        <ElForm label-width="140px" class="dc-form">
                ...
                <div class="container-form-wrap">
                  ...
                  >
                    ...
                    <ElFormItem label="容器名称">
                      <span class="dc-readonly-value">{{
                        containers[activeContainerIdx].name
                      }}</span>
                    </ElFormItem>
                    <ElFormItem label="镜像">
                      <ElInput
                    ...
                    <ElFormItem label="拉取策略">
                      <div class="advanced-field-wrap">
                        ...
                        <div class="dc-field-tip">
                          <template
                            v-if="containers[activeContainerIdx].imagePullPolicy === 'Always'"
                            >总是从远程拉取该镜像</template
                          >
                          <template
                            v-else-if="
                              containers[activeContainerIdx].imagePullPolicy === 'IfNotPresent'
                            "
                    ...
                    <ElFormItem label="环境变量">
                      <div class="kv-list">
                        ...
                        <ElButton
                          ...
                          type="primary"
                          class="kv-add-btn"
                          @click="addEnv(activeContainerIdx)"
                          >新增变量</ElButton
                        >
                      </div>
                    </ElFormItem>
                    ...
                    >
                        ...
                        <div class="cpu-mem-limit-block">
                          ...
                          <div class="cpu-mem-limit-inputs">
                            <div class="resource-affix-group resource-affix-group--grow">
                              ...
                              <ElInput
                                v-model="containers[activeContainerIdx].cpuRequest"
                                placeholder="不限制"
                            ...
                            <div class="resource-affix-group resource-affix-group--grow">
                              ...
                              <ElInput
                                v-model="containers[activeContainerIdx].cpuLimit"
                                placeholder="不限制"
                                class="resource-affix-input"
                              />
                            </div>
                        ...
                        <div class="cpu-mem-limit-block">
                          ...
                          <div class="cpu-mem-limit-inputs">
                            <div class="resource-affix-group resource-affix-group--grow">
                              <span class="resource-affix-label">request</span>
                              <ElInput
                                v-model="containers[activeContainerIdx].memoryRequest"
                                placeholder="不限制"
                                class="resource-affix-input"
                              />
                            </div>
                            ...
                            <div class="resource-affix-group resource-affix-group--grow">
                              <span class="resource-affix-label">limit</span>
                              <ElInput
                                v-model="containers[activeContainerIdx].memoryLimit"
                                placeholder="不限制"
                                class="resource-affix-input"
                              />
                            </div>
                      ...
                      <div class="cpu-mem-limit-tips">
                        <div class="dc-field-tip cpu-mem-tip-line"
                          ...
                          所要求的资源数量时，容器会创建失败。</div
                        >
                        <div class="dc-field-tip cpu-mem-tip-line"
                          >Limit
                          用于设置容器使用资源的最大上限，避免异常情况下节点资源消耗过多。</div
                        >
                      </div>
                    </ElFormItem>
                    <ElFormItem label="容器端口">
                      <div class="port-table">
                        <div
                          v-if="containers[activeContainerIdx].ports.length"
                        ...
                        >
                          ...
                          >
                            ...
                            <ElButton
                              link
                              class="kv-del-btn port-del-btn"
                              @click="removePort(activeContainerIdx, idx)"
                            >
                              <ElIcon><Close /></ElIcon>
                            </ElButton>
                          </div>
                        ...
                        <ElButton
                          ...
                          type="primary"
                          class="kv-add-btn"
                          @click="addPort(activeContainerIdx)"
                          >添加容器端口</ElButton
                        >
                      </div>
                    </ElFormItem>
                        ...
                        <div class="lifecycle-wrap">
                          <div class="lifecycle-section">
                            ...
                            <div class="lifecycle-inputs">
                              <div
                                v-for="(cmd, ci) in containers[activeContainerIdx]
                                  .postStartCommands"
                                :key="`post-${ci}`"
                        ...
                        <div class="health-check-wrap">
                          <div class="health-check-row">
                            ...
                            <span class="health-check-desc"
                              >检查容器是否正常，不正常则重启实例</span
                            >
                          </div>
                          <div
                            v-if="containers[activeContainerIdx].liveness.enabled"
                            class="health-check-panel"
                          >
                            <div class="probe-field-row">
                              <span class="probe-field-label">检查方法</span>
                              <ElSelect
                                v-model="containers[activeContainerIdx].liveness.method"
                                style="width: 200px"
                              >
                            ...
                            <div class="probe-field-row">
                              ...
                              <div class="probe-field-col">
                                <ElInput
                                  v-model="containers[activeContainerIdx].liveness.host"
                            ...
                            <div class="probe-field-row">
                              ...
                              <div class="probe-field-col">
                                <ElInput
                                  v-model="containers[activeContainerIdx].liveness.port"
                                  placeholder="请输入检查端口"
                                  style="width: 200px"
                                />
                            ...
                            <div class="probe-field-row">
                              ...
                              <div class="probe-field-col">
                                <div class="probe-input-unit">
                                  <ElInput
                                    v-model.number="
                                      containers[activeContainerIdx].liveness.initialDelaySeconds
                                    "
                                    style="width: 220px"
                                  />
                            ...
                            <div class="probe-field-row">
                              ...
                              <div class="probe-field-col">
                                <div class="probe-input-unit">
                                  <ElInput
                                    v-model.number="
                                      containers[activeContainerIdx].liveness.timeoutSeconds
                                    "
                                    style="width: 220px"
                                  />
                                  <span class="probe-unit">秒</span>
                            ...
                            <div class="probe-field-row">
                              ...
                              <div class="probe-field-col">
                                <div class="probe-input-unit">
                                  <ElInput
                                    v-model.number="
                                      containers[activeContainerIdx].liveness.periodSeconds
                                    "
                                    style="width: 220px"
                                  />
                                  <span class="probe-unit">秒</span>
                            ...
                            <div class="probe-field-row">
                              ...
                              <div class="probe-input-unit">
                                <ElInput
                                  v-model.number="
                                    containers[activeContainerIdx].liveness.successThreshold
                                  "
                                  style="width: 220px"
                                />
                          ...
                          <div class="health-check-row" style="margin-top: 8px">
                            <ElCheckbox
                              v-model="containers[activeContainerIdx].readiness.enabled"
                            />
                          ...
                          <div
                            v-if="containers[activeContainerIdx].readiness.enabled"
                            class="health-check-panel"
                          >
                            <div class="probe-field-row">
                              <span class="probe-field-label">检查方法</span>
                              <ElSelect
                                v-model="containers[activeContainerIdx].readiness.method"
                                style="width: 200px"
                              >
                                <ElOption label="TCP端口检查" value="tcp" />
                                <ElOption label="HTTP请求检查" value="http" />
                            ...
                            <div class="probe-field-row">
                              ...
                              <div class="probe-field-col">
                                <ElInput
                                  v-model="containers[activeContainerIdx].readiness.host"
                                  placeholder="默认为 Pod IP，一般不需要修改"
                                  style="width: 200px"
                                />
                                <div class="dc-field-tip"
                            ...
                            <div class="probe-field-row">
                              ...
                              <div class="probe-field-col">
                                <ElInput
                                  v-model="containers[activeContainerIdx].readiness.port"
                                  placeholder="请输入检查端口"
                                  style="width: 200px"
                                />
                                <div class="dc-field-tip">端口范围：1~65535，支持使用端口名</div>
                            ...
                            <div class="probe-field-row">
                              ...
                              <div class="probe-field-col">
                                <div class="probe-input-unit">
                                  <ElInput
                                    v-model.number="
                                      containers[activeContainerIdx].readiness.initialDelaySeconds
                                    "
                                    style="width: 220px"
                                  />
                                  <span class="probe-unit">秒</span>
                            ...
                            <div class="probe-field-row">
                              ...
                              <div class="probe-field-col">
                                <div class="probe-input-unit">
                                  <ElInput
                                    v-model.number="
                                      containers[activeContainerIdx].readiness.timeoutSeconds
                                    "
                                    style="width: 220px"
                                  />
                                  <span class="probe-unit">秒</span>
                            ...
                            <div class="probe-field-row">
                              ...
                              <div class="probe-field-col">
                                <div class="probe-input-unit">
                                  <ElInput
                                    v-model.number="
                                      containers[activeContainerIdx].readiness.periodSeconds
                                    "
                                    style="width: 220px"
                                  />
                                  <span class="probe-unit">秒</span>
                            ...
                            <div class="probe-field-row">
                              ...
                              <div class="probe-input-unit">
                                <ElInput
                                  v-model.number="
                                    containers[activeContainerIdx].readiness.successThreshold
                                  "
                                  style="width: 220px"
                                />
                                <span class="probe-unit">次</span>
          ...
          <template v-if="mode === 'schedule' && kind === 'cj'">
            <ElDivider content-position="left" class="dc-section-divider-top"
              >CronJob设置</ElDivider
            >
              ...
              <div class="dc-field-col">
                ...
                <div v-else class="schedule-cron-panel">
                  ...
                  <div class="dc-field-tip schedule-cron-format-hint">
                    格式：分 时 日 月 周（如
                    <span class="schedule-cron-example">0 0 * * *</span> 表示每天 00:00 执行一次）
                  </div>
                </div>
              </div>
            </ElFormItem>
            <ElFormItem label="保留成功Job数">
              <div class="dc-field-col">
                <ElInputNumber
                  v-model="cjSuccessfulJobsHistoryLimit"
                  :min="0"
                  :precision="0"
                  style="width: 160px"
                />
            ...
            <ElFormItem label="保留失败Job数">
              <div class="dc-field-col">
                <ElInputNumber
                  v-model="cjFailedJobsHistoryLimit"
                  :min="0"
                  :precision="0"
                  style="width: 160px"
                />
            ...
            <template v-if="strategyType === 'RollingUpdate'">
              <ElFormItem label="最大不可用">
                <div class="dc-field-col">
                  ...
                  <div class="dc-field-tip"
                    >滚动更新期间允许不可用的 Pod 最大数量或比例，默认 25%</div
                  >
                </div>
              </ElFormItem>
              <ElFormItem label="最大超出">
                <div class="dc-field-col">
                  ...
                  <div class="dc-field-tip"
                    >滚动更新期间允许超出期望副本数的 Pod 最大数量或比例，默认 25%</div
                  >
                </div>
              </ElFormItem>
            </template>
...
<script setup lang="ts">
  ...
  const kind = computed(
    () => String(route.query.kind ?? 'deploy') as 'deploy' | 'sts' | 'ds' | 'cj' | 'job'
  )
  ...
  async function loadWorkload() {
    ...
    try {
      ...
      if (kind.value === 'deploy') {
        ...
        const data = await fetchK8sCronJob(
          cluster.value,
          namespace.value,
          name.value,
        ...
        basicInfo.value = { name: name.value, namespace: namespace.value }
        extractSpec(
          (data.spec?.jobTemplate?.spec?.template?.spec ?? {}) as Parameters<typeof extractSpec>[0]
        )
        if (kind.value === 'cj') {
          cjSchedule.value = data.spec?.schedule ?? ''
          cjConcurrencyPolicy.value =
            ((data.spec as any)?.concurrencyPolicy as 'Allow' | 'Forbid' | 'Replace') ?? 'Allow'
          ...
          cjRestartPolicy.value =
            ((data.spec as any)?.jobTemplate?.spec?.template?.spec?.restartPolicy as
              | 'OnFailure'
              | 'Never') ?? 'OnFailure'
        }
      } else {
  ...
  function buildContainerPatch(c: ContainerState) {
    ...
    const ports = c.ports
      .filter((p) => p.containerPort > 0 && p.containerPort <= 65535)
      .map((p) => ({
  ...
  function buildPatch() {
    if (mode.value === 'strategy') {
      return {
        spec: {
          strategy:
            strategyType.value === 'RollingUpdate'
              ? {
                  type: 'RollingUpdate',
                  rollingUpdate: {
                    maxUnavailable: maxUnavailable.value || '25%',
                    maxSurge: maxSurge.value || '25%'
                  }
                }
              : { type: 'Recreate' },
    ...
    const pullSecretPatch = imagePullSecret.value ? [{ name: imagePullSecret.value }] : []
    const specPatch = {
      containers: regular,
    ...
    if (kind.value === 'cj' || kind.value === 'job') {
      ...
      if (kind.value === 'cj') {
        ...
        ;(cjPatch.spec as Record<string, unknown>).successfulJobsHistoryLimit =
          cjSuccessfulJobsHistoryLimit.value
        ;(cjPatch.spec as Record<string, unknown>).failedJobsHistoryLimit =
          cjFailedJobsHistoryLimit.value
        ;((cjPatch.spec as Record<string, any>).jobTemplate as Record<string, any>).spec = {
          ...((((cjPatch.spec as Record<string, any>).jobTemplate as Record<string, any>)
        ...
        if (cjStartingDeadlineSeconds.value !== null) {
          ;(cjPatch.spec as Record<string, unknown>).startingDeadlineSeconds =
            cjStartingDeadlineSeconds.value
        }
      }
      return cjPatch
    }
  ...
  function addEnv(cidx: number) {
    containers.value[cidx].envs.push({
      name: '',
      mode: 'value',
      value: '',
      sourceName: '',
  ...
  function removeEnv(cidx: number, idx: number) {
    containers.value[cidx].envs.splice(idx, 1)
  }
  function addPort(cidx: number) {
    containers.value[cidx].ports.push({ containerPort: 80, name: '', protocol: 'TCP' })
  }
  function removePort(cidx: number, idx: number) {
    containers.value[cidx].ports.splice(idx, 1)
  }
  function addPostStart() {
    containers.value[activeContainerIdx.value].postStartCommands.push('')
  }
  function removePostStart(idx: number) {
    containers.value[activeContainerIdx.value].postStartCommands.splice(idx, 1)
  }
  function addPreStop() {
    containers.value[activeContainerIdx.value].preStopCommands.push('')
  }
  function removePreStop(idx: number) {
    containers.value[activeContainerIdx.value].preStopCommands.splice(idx, 1)
  }
