...
export async function fetchK8sStatefulSet(
  cluster: string,
  namespace: string,
  name: string
...
export async function deleteK8sStatefulSet(
  cluster: string,
  namespace: string,
  name: string
): Promise<void> {
...
export async function patchK8sStatefulSet(
  cluster: string,
  namespace: string,
  name: string,
  patch: object
...
export async function createK8sStatefulSet(
  cluster: string,
  namespace: string,
  body: object
): Promise<K8sStatefulSet> {
